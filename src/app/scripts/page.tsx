          ...
          <div className="grid grid-cols-1 gap-8 relative z-10">
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Bu bölmədə faydalı GİS və xəritə alətlərini tapacaqsınız. Bu alətləri öz layihələrinizdə istifadə edə bilərsiniz.
              </p>

              {/* Alət kartları burada yerləşir */}
                ...
                >
                  ...
                  <div className="p-5 relative">
                    ...
                    <p className="text-gray-400 text-sm mb-4">
                      Sahə və məsafə ölçmək, tampon zonalar yaratmaq, kəsişmə və birləşmə analizləri aparmaq üçün çoxfunksiyalı bir alətdir.
                    </p>
