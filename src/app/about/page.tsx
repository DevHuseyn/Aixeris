...
export default function AboutPage() {
  ...
  const certificates = [
    {
      id: 1,
      title: "ESRI - Use a Map for Classroom Instruction",
      description: "Training completion certificate",
      mediaType: "pdf",
      embedSrc: "/certificates/esri-classroom.pdf#toolbar=0&zoom=100",
      viewSrc: "/certificates/esri-classroom.pdf"
    },
    {
      id: 2,
      ...
      mediaType: "pdf",
      embedSrc: "/certificates/esri-drone2map.pdf#toolbar=0&zoom=100",
      viewSrc: "/certificates/esri-drone2map.pdf"
    },
    {
      id: 3,
      title: "MASS Bilişim Ltd.",
      description: "Photogrammetric restitution & 3D Citymodels with CityGRID",
      mediaType: "pdf",
      embedSrc: "/certificates/mass-citygrid.pdf#toolbar=0&zoom=100",
      viewSrc: "/certificates/mass-citygrid.pdf"
    },
    {
      id: 4,
      title: "İTMİM - Könüllü Fəaliyyət",
      description: "Volunteer service recognition",
      mediaType: "image",
      embedSrc: "/certificates/itmim-volunteer.jpg",
      viewSrc: "/certificates/itmim-volunteer.jpg"
    },
    {
      id: 5,
      title: "İTMİM - Təşəkkürnamə",
      description: "Official appreciation letter",
      mediaType: "image",
      embedSrc: "/certificates/itmim-appreciation.jpg",
      viewSrc: "/certificates/itmim-appreciation.jpg"
    }
  ];
    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-[#1B4B6C] via-[#142F47] to-[#1A1A24] text-white relative">
            ...
            <div className="md:col-span-2 space-y-6">
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  Salam! Mən Hüseyn Hüseynli, Coğrafi Məlumat Sistemləri (GİS) üzrə ixtisaslaşmış xəritə və məkan analizləri mütəxəssisiyəm. Hal-hazırda Azərbaycanın{" "}
                  <a
                    href="https://www.esri.com/en-us/home"
                    className="italic text-[#00E5CC] transition-colors hover:text-[#8B6FFF]"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    ESRI
                  </a>{" "}
                  şirkətinin yeganə rəsmi partnyoru olan{" "}
                  <a
                    href="https://mina.az/"
                    className="italic text-[#00E5CC] transition-colors hover:text-[#8B6FFF]"
                    target="_blank"
                  ...
                  -də fəaliyyət göstərirəm. Karyeram boyunca GİS və məsafədən zondlama texnologiyalarından istifadə edərək müxtəlif sənaye sahələrində coğrafi problemlərə innovativ və data əsaslı həllər tətbiq etməyi hədəfləmişəm.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  <p>
                    ...
                    -də GİS mütəxəssisi olaraq çalışır və coğrafi məlumatların emalı, məkan analizlərinin aparılması, data inteqrasiyası, xəritələmə proseslərinin təşkili və ESRI ekosistemi üzərində GİS xidmətlərinin qurulması kimi vəzifələri icra edirəm. Coğrafi dataların təmizlənməsi, strukturlaşdırılması və analitik istifadə üçün hazırlanması, həmçinin dashboard, interaktiv xəritələr və müxtəlif analitik vizuallaşdırmaların yaradılması üzrə işlərlə məşğul oluram. Bununla yanaşı, müəssisədaxili GİS sistemlərinin səmərəli işləməsi üçün texniki dəstək və məlumat axınının idarə olunması sahəsində də fəaliyyət göstərirəm.
                  </p>
                  <p>
                    Bundan əvvəl 4Maps MMC-də komanda lideri və GİS mühəndisi olaraq mobil xəritələmə təşəbbüslərinə rəhbərlik etmiş, Nərimanov və Binəqədi rayonlarının 3D şəhər modellərinin hazırlanmasında aktiv rol almış və müxtəlif məkan analizləri həyata keçirmişəm.
                  </p>
                  <p>
                    Karyeramın əvvəlində Geodeziya və Kartoqrafiya MMC-də, eləcə də İqtisadiyyat Nazirliyinin tabeliyində İTMİM-də təcrübəçi olaraq çalışmış, sahə ölçmələri, məlumat emalı, vektorlaşdırma, kartoqrafik redaktə, fotogrammetriya və 3D modelləşdirmə kimi sahələrdə praktiki bacarıqlar əldə etmişəm.
                  </p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                  <div className="bg-[#0A1A2F]/70 p-4 rounded-lg border border-[#00B4A2]/10 transform transition-all duration-300 hover:border-[#00E5CC]/30 hover:translate-y-[-4px]">
                    ...
                    <p className="text-gray-300">
                      QGIS, ArcMap, ArcGIS və digər bir sıra{" "}
                      ESRI proqramları
                    </p>
                  </div>
                  <div className="bg-[#0A1A2F]/70 p-4 rounded-lg border border-[#00B4A2]/10 transform transition-all duration-300 hover:border-[#00E5CC]/30 hover:translate-y-[-4px]">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Eyni zamanda Ukraynanın{" "}
                  <a
                    href="https://ieu.edu.ua/en"
                    className="italic text-[#00E5CC] transition-colors hover:text-[#8B6FFF]"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  universitetində doktorantura təhsili alır və elmi araşdırmalarımı geoinformasiya sistemləri və məkan məlumatlarının analizi istiqamətində davam etdirirəm.
                </p>
              </div>
          ...
          <div className="bg-gradient-to-r from-[#142F47]/80 to-[#0A1A2F]/80 p-8 rounded-2xl border border-[#00B4A2]/20 backdrop-blur-sm shadow-xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {certificates.map((cert) => (
                ...
                >
                  <div className="h-72 relative overflow-hidden flex items-center justify-center bg-gradient-to-br from-[#10263B] to-[#1B4B6C]">
                    <div className="text-center px-6">
                      <div className="inline-flex items-center px-3 py-1 rounded-full text-xs uppercase tracking-wide bg-[#00E5CC]/10 text-[#00E5CC] border border-[#00E5CC]/30 mb-4">
                        {cert.mediaType === "pdf" ? "PDF" : "Şəkil"}
                      </div>
                      <h3 className="text-xl font-bold text-white mb-2">{cert.title}</h3>
                      <p className="text-sm text-gray-300">{cert.description}</p>
                      <div className="mt-4 text-[#00E5CC] text-sm flex items-center justify-center">
                        Sənədə baxmaq üçün klikləyin
      ...
      {activeCertificate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80">
          <div className="relative max-w-5xl w-full bg-[#0A1A2F] rounded-2xl border border-[#00B4A2]/30 shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#00B4A2]/20">
              <div>
                <p className="text-sm uppercase tracking-wide text-[#00E5CC]/80">Sertifikat</p>
                <h3 className="text-2xl font-semibold text-white">
                  {certificates.find(cert => cert.id === activeCertificate)?.title}
                </h3>
              </div>
              {(() => {
                const activeCert = certificates.find(cert => cert.id === activeCertificate);
                if (!activeCert?.viewSrc) return null;
                return (
                  <a
                    href={activeCert.viewSrc}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hidden sm:inline-flex items-center px-4 py-2 rounded-xl border border-[#00E5CC]/40 text-sm text-[#00E5CC] hover:bg-[#00E5CC]/10 transition-colors mr-3"
                  >
                    Orijinal sənəd
                    <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 3h7v7M10 14L21 3M5 7v14h14" />
                    </svg>
                  </a>
                );
              })()}
            ...
            <div className="bg-[#071120] px-6 py-3 text-sm text-gray-300 border-b border-[#00B4A2]/10">
              {certificates.find(cert => cert.id === activeCertificate)?.description}
            </div>
            <div className="relative bg-white h-[70vh]">
              {(() => {
                const activeCert = certificates.find(cert => cert.id === activeCertificate);
                if (!activeCert) return null;
                if (activeCert.mediaType === "image") {
                  return (
                    <Image
                      src={activeCert.embedSrc}
